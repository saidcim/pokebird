...
24 kHz mono WAV'a cevir. (M4 adim 4'un on kosulu, lastsession.md §9f-4)
    ...
    python tools/esc50_indir.py
    python tools/esc50_indir.py --sadece-cevir     # zip zaten indiyse
...
tools/egitim_kumesi.py o sonuclari bulursa kus duyulan klipleri de eler.
