...
FONTLAR = [
    ...
    ("pb_font_ad_18",       "LiberationSansNarrow-Bold.ttf",  18, 4),
    ("pb_font_kalin_13",    "LiberationSansNarrow-Bold.ttf",  13, 4),
    ("pb_font_dar_11",      "LiberationSansNarrow-Regular.ttf", 11, 4),
